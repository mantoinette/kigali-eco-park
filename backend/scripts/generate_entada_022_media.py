"""Generate unique Umusange TREE-022 (Entada abyssinica) park audio + video guides."""
...
TMP_DIR = MEDIA / "tmp" / "entada-abyssinica-022"
UPLOAD_IMAGES = ROOT / "uploads" / "trees" / "entada-abyssinica-022"

SCRIPTS = {
    "en": (
        "en-GB-SoniaNeural",
        """Welcome to Kigali Eco-Park. You are standing at Umusange, Entada abyssinica, the splinter bean — park label TREE-022.

Traditional healers use it for cough, side pain, respiratory disease, diarrhoea and fever. Research has found entadanin with antibacterial activity against Salmonella typhimurium, plus antioxidant and anticancer activity.

Look at the compound leaves and woody pods. Scan this tree's QR label anytime to reopen the full multilingual guide. Thank you for visiting Kigali Eco-Park.""",
    ),
    "fr": (
        "fr-FR-DeniseNeural",
        """Bienvenue au Kigali Eco-Park. Vous êtes devant Umusange, Entada abyssinica — étiquette TREE-022.

Médecine traditionnelle pour toux, douleurs de côté, maladies respiratoires, diarrhée et fièvre. L'entadanine agit contre Salmonella typhimurium et montre aussi une activité antioxydante et anticancéreuse.
...
Observez les feuilles et les gousses. Scannez l'étiquette QR pour rouvrir le guide multilingue. Merci de votre visite au Kigali Eco-Park.""",
    ...
    "rw": (
        "sw-TZ-RehemaNeural",
        """Murakaza neza muri Kigali Eco-Park. Uri imbere y'Umusange, Entada abyssinica — ikimenyetso TREE-022.

Abavuzi gakonda bayivuza: inkorora, rubagimpande, indwara z'ubuhumekero, gucibwamo n'umuriro. Ubushakashatsi bwabonye entadanin ivura kanseri ikarwanya bakteriya nka Salmonella typhimurium.
...
async def main() -> None:
    ...
    print("Done — Umusange (TREE-022) media is unique from TREE-009.")

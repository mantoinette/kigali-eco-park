...
/**
 * Senegalia polyacantha subsp. campylacantha (Umuharata / Ruganambuga / Falcon's claw acacia) — TREE-013.
 * Third park specimen of the falcon's claw acacia; content aligned with park ethnobotanical notes.
 * Distinct from TREE-008 and TREE-012 so each QR label has its own guide page.
 */
public final class SenegaliaPolyacanthaTree013Data {

    public static final String SLUG = "senegalia-polyacantha-tree-013";
    ...
    public static final double LONGITUDE = 30.1094;
    ...
    private SenegaliaPolyacanthaTree013Data() {}
    ...
    private static TreeTranslation english(Tree tree) {
        ...
        t.setDescription(
                ...
                "At Kigali Eco-Park this TREE-013 specimen is presented as Umuharata / Ruganambuga / falcon's claw " +
        ...
        t.setAdditionalInfo(
                ...
                "At Kigali Eco-Park, scan the QR on the Umuharata / Ruganambuga (TREE-013) label for photos, map " +
    ...
    private static TreeTranslation kinyarwanda(Tree tree) {
        ...
        t.setShortDescription(
                "Umuharata / Ruganambuga (Senegalia polyacantha subsp. campylacantha / Falcon's claw acacia) — " +
        ...
        t.setDescription(
                ...
                "Mu Kigali Eco-Park, iki cyerekanwa nk'Umuharata / Ruganambuga / falcon's claw acacia " +
                "(TREE-013) hakurikijwe amazina n'akamaro k'aho."
        );
        t.setUses(
                "Akamaro:\n" +
                "• Kugombora urumwe n'inzoka.\n" +
        ...
        t.setAdditionalInfo(
                ...
                "Sikana QR ku kimenyetso cy'Umuharata / Ruganambuga (TREE-013).\n\n" +
    ...
    private static TreeTranslation french(Tree tree) {
        ...
        t.setDescription(
                ...
                "des racines.\n\n" +
                "Au Kigali Eco-Park, le spécimen TREE-013 est présenté comme Umuharata / Ruganambuga."
        );
        t.setUses(
        ...
        t.setAdditionalInfo(
                ...
                "Scannez le QR de l'étiquette Umuharata / Ruganambuga (TREE-013).\n\n" +
